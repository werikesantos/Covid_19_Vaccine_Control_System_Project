...
CREATE TABLE `aplicacao` (
  ...
  CONSTRAINT `aplicacao_ibfk_1` FOREIGN KEY (`idCidadao`) REFERENCES `perfil` (`id`),
  CONSTRAINT `aplicacao_ibfk_2` FOREIGN KEY (`idVacina`) REFERENCES `perfil` (`id`)
...
INSERT INTO `aplicacao` VALUES (1,1,1,1,'null','20/05/2021','20/06/2021');
...
-- Dump completed on 2021-05-11 18:44:28
