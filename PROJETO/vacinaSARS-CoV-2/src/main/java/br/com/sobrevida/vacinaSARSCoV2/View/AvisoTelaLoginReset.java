 ...
 * @author WERIKE
 */
public class AvisoTelaLoginReset extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(310, 180));
        ...
        jLabel1.setText("RESET DE SENHA");

        jLabel2.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jLabel2.setText("Nova senha cadastrada com sucesso!");
        ...
        avisoSenha.setBounds(0, 13, 380, 90);
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        AvisoTelaLoginReset.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvisoTelaLoginReset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AvisoTelaLoginReset().setVisible(true);
            }
        });
    }
