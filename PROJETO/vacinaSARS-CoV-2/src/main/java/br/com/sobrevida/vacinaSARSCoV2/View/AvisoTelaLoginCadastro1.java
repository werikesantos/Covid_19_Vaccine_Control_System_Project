 ...
 * @author WERIKE
 */
public class AvisoTelaLoginCadastro1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Usuário cadastrado com sucesso!");
        ...
        avisoSenha.setBounds(0, 13, 310, 90);
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        AvisoTelaLoginCadastro1.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvisoTelaLoginCadastro1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AvisoTelaLoginCadastro1().setVisible(true);
            }
        });
    }
